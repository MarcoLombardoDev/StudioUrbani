...
(function () {
  ...
  var EN = {
    ...
    'hero.lead': "Studio Urbani assists companies, professionals and private clients in accounting, tax, employment and litigation matters. Tax, administrative, banking and financial advice, statutory audit, data processing and public relations: integrated expertise and a direct relationship.",
    'hero.cta1': "Explore our services",
    'hero.cta2': "Talk to the firm",
    ...
    /* --- valori --- */
    'values.1.t': "A single point of contact",
    'values.1.d': "Accounting, tax, employment and litigation handled together, with nothing lost in between.",
    'values.2.t': "A cloud-based firm",
    'values.2.d': "A client area for bookkeeping and electronic invoicing, available whenever you need it.",
    ...
    'services.title': "Nine practice areas, one single point of care.",
    ...
    'billing.title': "Electronic invoicing, without the friction.",
    'billing.lead': "As an alternative to the classic way of handling bookkeeping and payroll, the firm works in the cloud and provides a client area for managing accounting and issuing electronic invoices.",
    'billing.s1.t': "Client area set-up",
    'billing.s1.d': "The firm configures your credentials, master data and the transmission channel to the Italian Revenue Agency exchange system.",
    'billing.s2.t': "Issuing and receiving",
    'billing.s2.d': "Sales and purchase invoices travel in XML format: guided data entry, transmission, delivery and rejection notices.",
    'billing.s3.t': "Compliant archiving",
    'billing.s3.d': "Transmitted documents are collected, digitally preserved and always available for consultation and printing.",
    'billing.s4.t': "Accounting kept current",
    'billing.s4.d': "The data flows into the firm's bookkeeping: less paper to deliver, deadlines under control.",
    'billing.panel.t': "Client area",
    'billing.panel.d': "A dedicated access point to issue invoices, consult transmitted documents and exchange files with the firm securely.",
